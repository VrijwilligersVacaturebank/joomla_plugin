...
if(JV == 'j2') {
    //j2 stuff here///////////////////////////////////////////////////////////////////////////////////////////////////////
?>
 <form action="index.php?option=com_vrijwilligersvacaturebank_nl" method="post" name="adminForm" id="adminForm">
        ...
        <div id="tablecell">
            ...
            <thead>
                <tr>
                    ...
                    <th class="key">
                        <?php echo JHTML::_('grid.sort', 'Key', 'm.key', @$this->filter->filter_order_Dir, @$this->filter->filter_order ); ?>
                    </th>
                    <th width="30%" align="center">
                        <?php echo JHTML::_('grid.sort', 'Route', 'm.route',  @$this->filter->filter_order_Dir, @$this->filter->filter_order ); ?>
                    </th>
            ...
            for ($i=0, $n=count( $this->items ); $i < $n; $i++) {
                ...
                $link = JRoute::_( 'index.php?option=com_vrijwilligersvacaturebank_nl&controller=application&task=edit&cid[]='. $row->id );
